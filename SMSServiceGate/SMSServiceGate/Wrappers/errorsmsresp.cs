...
namespace Csharper.SMSServiceGate.Wrappers
{
   /// <summary>
/// <para>
...
public partial class response : XTypedElement, IXMetaData {
    ...
    static response() {
        ...
        contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("msg", "")));
    }
    ...
    public string msg {
        get {
            XElement x = this.GetElement(XName.Get("msg", ""));
            return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
        }
        set {
            this.SetElement(XName.Get("msg", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
        }
    }
    ...
    private static void BuildElementDictionary() {
        localElementDictionary.Add(XName.Get("msg", ""), typeof(string));
    }
