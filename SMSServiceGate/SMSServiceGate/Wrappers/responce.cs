...
namespace Csharper.SMSServiceGate.Wrappers.SendSMSResp
{
    ...
    public partial class response : XTypedElement, IXMetaData
    {
        ...
        public partial class smsLocalType : XTypedElement, IXMetaData
        {
            ...
            public uint parts
            {
                get
                {
                    XAttribute x = this.Attribute(XName.Get("parts", ""));
                    return XTypedServices.ParseValue<uint>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.UnsignedInt).Datatype);
                }
                set
                {
                    this.SetAttribute(XName.Get("parts", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.UnsignedInt).Datatype);
                }
            }
            ...
            public uint part_no
            {
                get
                {
                    XAttribute x = this.Attribute(XName.Get("part_no", ""));
                    return XTypedServices.ParseValue<uint>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.UnsignedInt).Datatype);
                }
                set
                {
                    this.SetAttribute(XName.Get("part_no", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.UnsignedInt).Datatype);
                }
            }
